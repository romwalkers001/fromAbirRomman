...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Aug 18, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Happy Birthday NAYIMA (in advance) It’s been a long time — life has changed, and so have we. But some feelings quietly remain, untouched by time.Even today, on your birthday, memories come flooding back — the little moments that once meant everything.Maybe we’re strangers now, living different lives, but in a small, quiet corner of my heart, you still exist, just like before."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["I genuinely wish you all the happiness, love, and peace in the world — today and always.I haven’t forgotten you, and maybe… I never really will.This message isn’t meant to change anything — just a reminder that someone, somewhere, still remembers you with a full heart.Take care, always"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
